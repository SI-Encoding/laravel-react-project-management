...
export default function Index({ auth, projects, totalProjects, queryParams = null, success }) {
                    ...
                    {projects.data.map((project) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={
                              `px-2 py-1 rounded-full text-white text-xs font-semibold whitespace-nowrap 
